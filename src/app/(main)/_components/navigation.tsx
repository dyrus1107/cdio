...
const Navigation = () => {
  ...
  const handleMouseMove = (event: MouseEvent) => {
    ...
    // Limit the width of the sidebar
    ...
    <>
      ...
      >
        ...
        <div
          ...
          onClick={resetWidth}
          className="opacity-0 transition group-hover/sidebar:opacity-100 absolute top-0 right-0 h-full w-1 bg-gray-400 cursor-ew-resize"
        ></div>
      </aside>
      <div
        ref={navbarRef}
